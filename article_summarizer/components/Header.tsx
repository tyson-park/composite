      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="hidden md:block">
          <ul className="flex space-x-4">
            ...
            <li><button onClick={handleFinanceNewsSummaryClick} className="text-white">증권사 레포트 요약</button></li>
          </ul>
        </nav>
      ...
      {isMenuOpen && (
        <nav className="md:hidden mt-2">
          <ul className="flex flex-col space-y-2">
            ...
            <li><button onClick={handleFinanceNewsSummaryClick} className="block py-2 text-left">증권사 레포트 요약</button></li>
          </ul>
        </nav>
      )}
    </header>
